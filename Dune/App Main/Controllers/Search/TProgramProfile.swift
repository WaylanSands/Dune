...
class TProgramProfileVC: UIViewController {
...
extension TProgramProfileVC: UIScrollViewDelegate {
...
extension TProgramProfileVC: SettingsLauncherDelegate {
