...
//    self.questionTextFont = UIFont.systemFont(ofSize: 16, weight: .semibold)
    self.backgroundColor = .white
    self.separatorColor = CustomStyle.secondShade
  }
...
public class FAQConfiguration {
  ...
  func defaultValue() {
    self.questionTextColor = CustomStyle.primaryBlack
    self.answerTextColor = CustomStyle.sixthShade
    self.questionTextFont = UIFont.systemFont(ofSize: 15, weight: .semibold)
    self.answerTextFont = UIFont.systemFont(ofSize: 14, weight: .regular)
...
class FAQViewCell: UITableViewCell {
  ...
  var indicatorImageView: UIImageView = {
    ...
    imageView.image = UIImage(named: "episode-settings")
    return imageView
  }()
  ...
  private func setup(with configuration: FAQConfiguration) {
    ...
    let questionLabelTop = NSLayoutConstraint(item: questionLabel, attribute: .top, relatedBy: .equal, toItem: contentView, attribute: .top, multiplier: 1, constant: 0)
        questionLabel.heightAnchor.constraint(equalToConstant: 60).isActive =  true
    
    let answerTextViewTrailing = NSLayoutConstraint(item: answerTextView, attribute: .trailing, relatedBy: .equal, toItem: contentView, attribute: .trailingMargin, multiplier: 1, constant: -16)
    ...
    let answerTextViewTop = NSLayoutConstraint(item: answerTextView, attribute: .top, relatedBy: .equal, toItem: questionLabel, attribute: .bottom, multiplier: 1, constant: 5)
    ...
    let indicatorVerticalCenter = NSLayoutConstraint(item: indicatorImageView, attribute: .centerY, relatedBy: .equal, toItem: questionLabel, attribute: .centerY, multiplier: 1, constant: 0)
