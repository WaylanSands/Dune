...
//import UIKit
//
//class PublisherAddSummaryVCHolder: UIViewController {
//
//    let maxCharacters = 200
//    let maxSummaryLines = 7
...
//            secondaryImageView.setImage(from: Program.imagePath!)
//        } else {
//            largeUserImage.image = #imageLiteral(resourceName: "missing-image-large")
//            secondaryImageView.image = #imageLiteral(resourceName: "missing-image-large")
//        }
//    }
//
...
//}
//
//extension PublisherAddSummaryVCHolder: UITextViewDelegate, CustomAlertDelegate {
//
